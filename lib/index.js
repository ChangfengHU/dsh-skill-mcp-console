...
var AppInstaller = class {
  ...
  async installDshSkills(entry, names) {
    ...
    for (const name2 of names) {
      ...
      try {
        await access(target);
        if (!owned.includes(name2)) throw new Error(`Skill ${name2} \u5DF2\u72EC\u7ACB\u5B89\u88C5\uFF1B\u4E3A\u907F\u514D\u8986\u76D6\uFF0CApp \u5B89\u88C5\u5DF2\u505C\u6B62`);
      } catch (cause) {
  ...
  async writeReceipt(entry, mcpAdded, status = "installed", lastError) {
